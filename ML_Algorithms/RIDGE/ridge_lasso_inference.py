# ML_Algorithms/RidgeLasso/ridge_lasso_inference.py
...
logger = logging.getLogger("RidgeLassoInference")
...
class RidgeLassoInference(BaseInferenceProcessor):
    """Inference processor for Ridge/Lasso using 2D features (X_t -> y(t+1..H))."""
    ...
    def _prepare_input_data(self, payload: dict):
        ...
        # scale with feature scaler if available
        X_in = X_row.values
